...
c1.quotes.create(:title => 'devis 1',:starttime => 1.months.ago ,:total => 1200,:status => 0,:tax_rate => 0.07,:list => [['plomberie','u',1,1200]])
c2.quotes.create(:title => 'devis 2',:starttime => 2.months.ago ,:total => 2400,:status => 1,:tax_rate => 0.2,:list => [['plomberie','u',1,1200],['menuiserie','u',1,1200]]  )
c1.quotes.create(:title => 'devis 3',:starttime => 1.months.ago ,:total => 3600,:status => 2,:comment=> 'dsnonsd f fdssdsdfsfd',:tax_rate => 0.07,:list => [['plomberie','u',1,1200],['menuiserie','u',1,1200],['maconnerie','u',1,1200]] )
